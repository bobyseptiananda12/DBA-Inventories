        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="Tujuan_Penggunaan2" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="frm-status"></div>
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="form-group">
                                                    <label>Tujuan Penggunaan</label>
                                                    <input type="text" class="form-control" id="Tujuan_Penggunaan" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                function editData(db_data){
                    ...
                    $('#Tujuan_Penggunaan').val(db_data.Tujuan_Penggunaan);
                    $('#dbID').val(db_data.id);
                    $('#dbDataModal').modal('show');
                }
                ...
                function viewData(db_data){
                    ...
                    $('#Tujuan_Penggunaan2').val(db_data.Tujuan_Penggunaan);
                ...
                function submitUserData(){
                    ...
                    let input_data_arr = [
                        ...
                        document.getElementById('Tujuan_Penggunaan').value,
