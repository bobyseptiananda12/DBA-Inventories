        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">DB Oracle Prod</h1>
                    <!-- DataTables -->
                    <?php
                    ...
                    if (isset($_POST['tambah'])) {
                        //tambah
                        $sql = "INSERT INTO dboracleprod VALUES ('', '$Tanggal', '$Hostname', '$Type', '$IP_Public', '$IP_VIP', '$IP_Backup', '$Database', '$Whitelist', '$App', '$Disk_Type', '$PDB', '$Port', '$Lokasi', '$Tier', '$Oracle_Version', '$Cluster','$OS_Version', '$Core', '$Socket', '$CPU', '$PIC', '$Keterangan', '$Tujuan_Penggunaan', CURRENT_TIMESTAMP() , '$username', CURRENT_TIMESTAMP() , '$username')";
                        if (mysqli_query($conn, $sql)) {
                            $nilaihasil = "Records inserted successfully.";

                            // Menambahkan log ke dalam tabel log activities
                            $timestamp = date("Y-m-d H:i:s");
                            $database = "dboracleprod";
                    ...
                    if (isset($_POST['edit'])) {
                        ...
                        $sql_before_update = "SELECT * FROM dboracleprod WHERE id = '$id'";
                        $result_before_update = mysqli_query($conn, $sql_before_update);
                        $row_before_update = mysqli_fetch_assoc($result_before_update);
                    
                        // Update the record
                        $sql = "UPDATE dboracleprod SET Tanggal = '$Tanggal', Hostname = '$Hostname', `Type` = '$Type', IP_Public = '$IP_Public', IP_VIP = '$IP_VIP', IP_Backup = '$IP_Backup', `Database` = '$Database', Whitelist = '$Whitelist', App = '$App', Disk_Type = '$Disk_Type', PDB = '$PDB', Port = '$Port', Lokasi = '$Lokasi', Tier = '$Tier', Oracle_Version = '$Oracle_Version', Cluster = '$Cluster', OS_Version = '$OS_Version', Core = '$Core', Socket = '$Socket', CPU = '$CPU', PIC = '$PIC', Keterangan = '$Keterangan', Tujuan_Penggunaan = '$Tujuan_Penggunaan', lastUpdatedAt = CURRENT_TIMESTAMP() WHERE id = '$id'";
                    
                        if (mysqli_query($conn, $sql)) {
                            $nilaihasil = "Records updated successfully.";
                    
                            // Retrieve updated values after the update
                            $sql_after_update = "SELECT * FROM dboracleprod WHERE id = '$id'";
                    ...
                    if (isset($_POST['delete'])) {
                        ...
                        $sql_select = "SELECT * FROM dboracleprod WHERE id = '$id'";
                        $result = mysqli_query($conn, $sql_select);
                        $deleted_data = mysqli_fetch_assoc($result);
                    
                        // Operasi DELETE
                        $sql_delete = "DELETE FROM dboracleprod WHERE id = '$id'";
                    ...
                    if (isset($_POST['deleteall'])) {
                        //delete
                        $pilih = $_POST['pilih'];
                        $sql = "DELETE FROM dboracleprod WHERE id IN (" . implode(",", $pilih) . ")";
                        if (mysqli_query($conn, $sql)) {
                            $nilaihasil = "Records deleted successfully.";
                        } else {
                            // echo "ERROR: Could not able to execute $sql. " . mysqli_error($conn);
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">List Inventory DB Oracle Prod</h6>
